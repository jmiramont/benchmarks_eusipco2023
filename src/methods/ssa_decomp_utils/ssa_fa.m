...
% Step 4: Reconstruction
   ...
   %figure(2);  
   %subplot(2,1,1); xlabel('Data plot'); ylabel('Original and reconstructed series')
   %plot(1:N, x1, 1:N, y, 'r'); grid on

   r=x1-y;
   %subplot(2,1,2); plot(1:N,r,'g'); xlabel('Data plot'); ylabel('Residual series'); grid on
   %vr=(sum(d(I))/sev)*100;
