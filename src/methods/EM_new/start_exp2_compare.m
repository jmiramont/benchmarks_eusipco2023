...
MCrep = 10; %100;     % number of Monte Carlo iterations (increase to obtain smooth curves)
...
methods_name = {'Brevdo SST', 'Brevdo STFT', 'SSA', 'Proposed \beta=1, Beta div.', 'Proposed KL div.', ... %% 1-6
                'Proposed \alpha=0.9, Renyi div.', sprintf('Oracle \\Gamma=%.2f', gamma_mask) ...          %% 7-9
                'Nils 1', 'Nils 2', 'Nils 3', 'Nils 4', 'Nils spl', 'Nils spl lcr'};                       %% 10-15
%methods_to_use = [4 5 6 7 1 2 3];   % insert here the indices of the methods to compare (names above)
%methods_to_use = [1 2 3 7];   % insert here the indices of the methods to compare (names above)
