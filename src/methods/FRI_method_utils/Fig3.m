...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Generate Fig.3 of the paper ESTIMATION OF OVERLAPPING MODES USING SPARSE MODELING OF SIGNALINNOVATION
%  Comparison of the RMSE in the overlapping case
%
...
%% Method parameters
Pnei = 20; % the output mask is of size 2*Pnei+1 -> extract only the ridge position
...
%% Initialization
methods_name = {'PB-\beta=0.3,Beta-div. [9]',    'PB-\beta=0.7,Beta-div. [9]',...
                'PB-\alpha=0.3,Renyi-div. [9]',  'FRI',...
                'FRI_TLSD'
                };
